...
class DiceCounterTest {
    ...
    fun `Ex1_given one dice we get the expected result`(sumOfDices: Int, expected: Int) {
        val diceCounter = DiceCounter()
        val result = diceCounter.howManyPossibilitiesToObtain(1, sumOfDices)
    ...
    fun `EX2_given two dices we get the expected result`(sumOfDices: Int, expected: Int) {
        val diceCounter = DiceCounter()
        val result = diceCounter.howManyPossibilitiesToObtain(2, sumOfDices)
        assertEquals(expected, result)
    }
    ...
    fun `EX3_given n dices we get the expected result`(numberOfDices: Int, sumOfDices: Int, expected: Int) {
        val diceCounter = DiceCounter()
        val result = diceCounter.howManyPossibilitiesToObtain(numberOfDices, sumOfDices)
        assertEquals(expected, result)
    }
